...
export default function InternationalSection({ data, lang }: { data: any[], lang: 'en' | 'zh' }) {
  return (
    <section className="space-y-8">
      <div className="flex items-center space-x-4">
        <div className="h-6 w-1.5 bg-blue-500 rounded-full shadow-[0_0_15px_rgba(59,130,246,0.5)]" />
        <h2 className="text-2xl font-black tracking-tight text-zinc-100 italic uppercase">International</h2>
      </div>
          ...
          return (
            <article key={item.id} className="group space-y-3">
              <div className="flex items-center justify-between border-b border-zinc-900 pb-2">
                <span className="text-[10px] font-bold text-zinc-600 tracking-widest uppercase">{item.source || 'GLOBAL'}</span>
              ...
              <h3 className="text-xl font-bold text-zinc-100 leading-tight group-hover:text-blue-400 transition-colors duration-300">
